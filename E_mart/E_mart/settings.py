...
import os
from datetime import timedelta # Keep this import for SIMPLE_JWT
...
SECRET_KEY = 'django-insecure-g^ff^h_3w12^r#68bgk7i^n)!-9)3-&3##&$rn(_cu!x9pomp5'
...
# You can also add REST Framework settings here if needed, for example:
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny', # Default to allow all, adjust as needed
    ],
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.PageNumberPagination',
    'PAGE_SIZE': 10
}

# ADD THESE SIMPLE_JWT SETTINGS
SIMPLE_JWT = {
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'E_mart.context_processors.wishlist_context',   # Added cart context processor
            ],
        },
    },
]
...
LOGIN_URL = '/accounts/login/' # ADDED THIS LINE

LOGIN_REDIRECT_URL = 'index'
LOGOUT_REDIRECT_URL = 'index'

# Password reset settings (optional but recommended)
